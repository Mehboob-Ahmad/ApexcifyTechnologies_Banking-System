...
public:
    ...
    void checkLoanStatus() {
        ...
        char buffer[26]; // Buffer to hold the formatted date string
        ctime_s(buffer, sizeof(buffer), &startDate); // Use ctime_s to safely format the date

        cout << "Loan started on: " << buffer;
